...
#echo "making server"
#gcc -std=c++11 -lSDL -lstdc++ -o openwideworlds_server src/window.cpp src/server.cpp src/timer.cpp src/mysql.cpp src/draw.cpp src/game.cpp `mysql_config --cflags --libs`
#echo "server ready"
